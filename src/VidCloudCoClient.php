...
class VidCloudCoClient
{
    ...
    /**
     * The VidCloudCo service client constructor
     *
    ...
    /**
     * Processes the VidCloudCo API request
     *
    ...
    /**
     * Processes the VidCloudCo API response and returns the result
     *
     * @param ResponseInterface $response The VidCloudCo API response
     *
     * @return mixed
     *
